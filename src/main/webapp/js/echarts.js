...
$(function () {
    ...
    function map() {
        ...
        var mapName = 'china'
        var data = [
            {name: '北京', num: 712049,value:77},
            {name: '上海', num: 998341,value:97},
            {name: '重庆', num: 276327,value:53},
            {name: '黑龙江', num: 41816,value:20},
            {name: '吉林', num: 72990,value:35},
            {name: '河北', num: 437083,value:70},
            {name: '山东', num: 906464,value:90},
            {name: '陕西', num: 304389,value:56},
            {name: '河南', num:836891,value:82},
            {name: '湖北',  num: 395896,value:64},
            {name: '湖南', num: 362991,value:60},
            {name: '江西', num: 235562,value:48},
            {name: '安徽', num: 410299,value:66},
            {name: '广西', num: 436217,value:68},
            {name: '广东', num: 1998110,value:101},
            {name: '台湾', num: 309091,value:59},
            {name: '香港', num: 205432,value:46},
            {name: '福建', num: 362061,value:59},
            {name: '江苏', num: 979869,value:95},
            {name: '浙江', num: 1339482,value:100},
            {name: '海南', num: 186127,value:42},
            {name: '四川', num: 544957,value:72},
            {name: '云南', num: 213452,value:45},
            {name: '贵州', num: 172483,value:40},
            {name: '青海', num: 10836,value:12},
            {name: '宁夏', num: 24328,value:16},
            {name: '甘肃', num: 57558,value:26},
            {name: '新疆', num: 46217,value:22},
            {name: '内蒙古', num: 64120,value:32},
            {name: '西藏', num: 3383,value:5},
            {name: '辽宁', num: 128119,value:38},
            {name: '天津', num: 374669,value:63},
            {name: '山西', num: 265323,value:51},
            {name: '澳门', num: 95872,value:35}
        ];
        var geoCoordMap= {};
        var toolTipData = [];
        var convertData1 = function (data,name) {
            //var res ;
        ...
        mapFeatures.forEach(function(v) {
            ...
            toolTipData.push({
                name: name,
                //var num = convertData(data,name);
                value: [{
                    name: "实时移动设备使用人数",
                    value: data[convertData1(data,name)].num
                }
                ]
            })
        });
